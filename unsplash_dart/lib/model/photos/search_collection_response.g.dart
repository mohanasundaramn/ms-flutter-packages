...
_$_SearchCollectionResponse _$$_SearchCollectionResponseFromJson(
        Map<String, dynamic> json) =>
    _$_SearchCollectionResponse(
...
Map<String, dynamic> _$$_SearchCollectionResponseToJson(
        _$_SearchCollectionResponse instance) =>
    <String, dynamic>{
...
_$_SourceCoverPhoto _$$_SourceCoverPhotoFromJson(Map<String, dynamic> json) =>
    _$_SourceCoverPhoto(
      id: json['id'] as String?,
      createdAt: json['created_at'] == null
          ? null
...
Map<String, dynamic> _$$_SourceCoverPhotoToJson(_$_SourceCoverPhoto instance) =>
    <String, dynamic>{
      'id': instance.id,
      'created_at': instance.createdAt?.toIso8601String(),
      'updated_at': instance.updatedAt?.toIso8601String(),
