...
part of 'collections_related_photo_response.dart';
...
CollectionsRelatedPhotoResponse _$CollectionsRelatedPhotoResponseFromJson(
    Map<String, dynamic> json) {
  return _CollectionsRelatedPhotoResponse.fromJson(json);
}

/// @nodoc
class _$CollectionsRelatedPhotoResponseTearOff {
  const _$CollectionsRelatedPhotoResponseTearOff();

  _CollectionsRelatedPhotoResponse call(
      {String? id,
      String? title,
      String? description,
    ...
    return _CollectionsRelatedPhotoResponse(
      id: id,
      title: title,
  ...
  CollectionsRelatedPhotoResponse fromJson(Map<String, Object> json) {
    return CollectionsRelatedPhotoResponse.fromJson(json);
  }
}

/// @nodoc
const $CollectionsRelatedPhotoResponse =
    _$CollectionsRelatedPhotoResponseTearOff();

/// @nodoc
mixin _$CollectionsRelatedPhotoResponse {
  ...
  CollectionsRelatedPhotoResponseLinks? get links =>
      throw _privateConstructorUsedError;
  User? get user => throw _privateConstructorUsedError;
  @JsonKey(name: "cover_photo")
  CollectionsRelatedPhotoResponseCoverPhoto? get coverPhoto =>
      throw _privateConstructorUsedError;
  @JsonKey(name: "preview_photos")
  ...
  @JsonKey(ignore: true)
  $CollectionsRelatedPhotoResponseCopyWith<CollectionsRelatedPhotoResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CollectionsRelatedPhotoResponseCopyWith<$Res> {
  factory $CollectionsRelatedPhotoResponseCopyWith(
          CollectionsRelatedPhotoResponse value,
          $Res Function(CollectionsRelatedPhotoResponse) then) =
      _$CollectionsRelatedPhotoResponseCopyWithImpl<$Res>;
  $Res call(
      {String? id,
      String? title,
      String? description,
  ...
  $CollectionsRelatedPhotoResponseLinksCopyWith<$Res>? get links;
  $UserCopyWith<$Res>? get user;
  $CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res>? get coverPhoto;
}

/// @nodoc
class _$CollectionsRelatedPhotoResponseCopyWithImpl<$Res>
    implements $CollectionsRelatedPhotoResponseCopyWith<$Res> {
  _$CollectionsRelatedPhotoResponseCopyWithImpl(this._value, this._then);

  final CollectionsRelatedPhotoResponse _value;
  // ignore: unused_field
  final $Res Function(CollectionsRelatedPhotoResponse) _then;
    ...
    return _then(_value.copyWith(
      ...
      links: links == freezed
          ...
          : links // ignore: cast_nullable_to_non_nullable
              as CollectionsRelatedPhotoResponseLinks?,
      user: user == freezed
          ? _value.user
      ...
      coverPhoto: coverPhoto == freezed
          ...
          : coverPhoto // ignore: cast_nullable_to_non_nullable
              as CollectionsRelatedPhotoResponseCoverPhoto?,
  ...
  $CollectionsRelatedPhotoResponseLinksCopyWith<$Res>? get links {
    ...
    return $CollectionsRelatedPhotoResponseLinksCopyWith<$Res>(_value.links!,
        (value) {
  ...
  $CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res>? get coverPhoto {
    ...
    return $CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res>(
        _value.coverPhoto!, (value) {
...
/// @nodoc
abstract class _$CollectionsRelatedPhotoResponseCopyWith<$Res>
    implements $CollectionsRelatedPhotoResponseCopyWith<$Res> {
  factory _$CollectionsRelatedPhotoResponseCopyWith(
          _CollectionsRelatedPhotoResponse value,
          $Res Function(_CollectionsRelatedPhotoResponse) then) =
      __$CollectionsRelatedPhotoResponseCopyWithImpl<$Res>;
  @override
  $Res call(
      {String? id,
      String? title,
...
/// @nodoc
class __$CollectionsRelatedPhotoResponseCopyWithImpl<$Res>
    extends _$CollectionsRelatedPhotoResponseCopyWithImpl<$Res>
    implements _$CollectionsRelatedPhotoResponseCopyWith<$Res> {
  __$CollectionsRelatedPhotoResponseCopyWithImpl(
      _CollectionsRelatedPhotoResponse _value,
      $Res Function(_CollectionsRelatedPhotoResponse) _then)
      : super(_value, (v) => _then(v as _CollectionsRelatedPhotoResponse));

  @override
  _CollectionsRelatedPhotoResponse get _value =>
      super._value as _CollectionsRelatedPhotoResponse;
  ...
  $Res call({
    ...
    return _then(_CollectionsRelatedPhotoResponse(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_CollectionsRelatedPhotoResponse
    implements _CollectionsRelatedPhotoResponse {
  const _$_CollectionsRelatedPhotoResponse(
      {this.id,
      this.title,
      this.description,
  ...
  factory _$_CollectionsRelatedPhotoResponse.fromJson(
          Map<String, dynamic> json) =>
      _$$_CollectionsRelatedPhotoResponseFromJson(json);
  ...
  final List<Tag>? tags;
  @override
  final CollectionsRelatedPhotoResponseLinks? links;
  @override
  final User? user;
  @override
  @JsonKey(name: "cover_photo")
  final CollectionsRelatedPhotoResponseCoverPhoto? coverPhoto;
  @override
  @JsonKey(name: "preview_photos")
  ...
  @override
  String toString() {
    return 'CollectionsRelatedPhotoResponse(id: $id, title: $title, description: $description, publishedAt: $publishedAt, updatedAt: $updatedAt, lastCollectedAt: $lastCollectedAt, curated: $curated, featured: $featured, totalPhotos: $totalPhotos, private: $private, shareKey: $shareKey, tags: $tags, links: $links, user: $user, coverPhoto: $coverPhoto, previewPhotos: $previewPhotos)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _CollectionsRelatedPhotoResponse &&
  ...
  @JsonKey(ignore: true)
  @override
  _$CollectionsRelatedPhotoResponseCopyWith<_CollectionsRelatedPhotoResponse>
      get copyWith => __$CollectionsRelatedPhotoResponseCopyWithImpl<
          _CollectionsRelatedPhotoResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CollectionsRelatedPhotoResponseToJson(this);
  }
}

abstract class _CollectionsRelatedPhotoResponse
    implements CollectionsRelatedPhotoResponse {
  const factory _CollectionsRelatedPhotoResponse(
          {String? id,
          String? title,
          String? description,
          @JsonKey(name: "published_at")
          ...
          @JsonKey(name: "preview_photos")
              List<PreviewPhoto>? previewPhotos}) =
      _$_CollectionsRelatedPhotoResponse;

  factory _CollectionsRelatedPhotoResponse.fromJson(Map<String, dynamic> json) =
      _$_CollectionsRelatedPhotoResponse.fromJson;
...
CollectionsRelatedPhotoResponseCoverPhoto
    _$CollectionsRelatedPhotoResponseCoverPhotoFromJson(
        Map<String, dynamic> json) {
  return _CollectionsRelatedPhotoResponseCoverPhoto.fromJson(json);
}

/// @nodoc
class _$CollectionsRelatedPhotoResponseCoverPhotoTearOff {
  const _$CollectionsRelatedPhotoResponseCoverPhotoTearOff();

  _CollectionsRelatedPhotoResponseCoverPhoto call(
      {String? id,
      ...
      User? user}) {
    return _CollectionsRelatedPhotoResponseCoverPhoto(
      id: id,
      createdAt: createdAt,
      updatedAt: updatedAt,
  ...
  CollectionsRelatedPhotoResponseCoverPhoto fromJson(Map<String, Object> json) {
    return CollectionsRelatedPhotoResponseCoverPhoto.fromJson(json);
  }
}

/// @nodoc
const $CollectionsRelatedPhotoResponseCoverPhoto =
    _$CollectionsRelatedPhotoResponseCoverPhotoTearOff();

/// @nodoc
mixin _$CollectionsRelatedPhotoResponseCoverPhoto {
  String? get id => throw _privateConstructorUsedError;
  @JsonKey(name: "created_at")
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $CollectionsRelatedPhotoResponseCoverPhotoCopyWith<
          CollectionsRelatedPhotoResponseCoverPhoto>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res> {
  factory $CollectionsRelatedPhotoResponseCoverPhotoCopyWith(
          CollectionsRelatedPhotoResponseCoverPhoto value,
          $Res Function(CollectionsRelatedPhotoResponseCoverPhoto) then) =
      _$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl<$Res>;
  $Res call(
      {String? id,
      @JsonKey(name: "created_at")
          DateTime? createdAt,
...
/// @nodoc
class _$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl<$Res>
    implements $CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res> {
  _$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl(
      this._value, this._then);

  final CollectionsRelatedPhotoResponseCoverPhoto _value;
  // ignore: unused_field
  final $Res Function(CollectionsRelatedPhotoResponseCoverPhoto) _then;
...
/// @nodoc
abstract class _$CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res>
    implements $CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res> {
  factory _$CollectionsRelatedPhotoResponseCoverPhotoCopyWith(
          _CollectionsRelatedPhotoResponseCoverPhoto value,
          $Res Function(_CollectionsRelatedPhotoResponseCoverPhoto) then) =
      __$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl<$Res>;
  @override
  $Res call(
      {String? id,
      @JsonKey(name: "created_at")
...
/// @nodoc
class __$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl<$Res>
    extends _$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl<$Res>
    implements _$CollectionsRelatedPhotoResponseCoverPhotoCopyWith<$Res> {
  __$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl(
      _CollectionsRelatedPhotoResponseCoverPhoto _value,
      $Res Function(_CollectionsRelatedPhotoResponseCoverPhoto) _then)
      : super(_value,
            (v) => _then(v as _CollectionsRelatedPhotoResponseCoverPhoto));

  @override
  _CollectionsRelatedPhotoResponseCoverPhoto get _value =>
      super._value as _CollectionsRelatedPhotoResponseCoverPhoto;
  ...
  $Res call({
    ...
    return _then(_CollectionsRelatedPhotoResponseCoverPhoto(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_CollectionsRelatedPhotoResponseCoverPhoto
    implements _CollectionsRelatedPhotoResponseCoverPhoto {
  const _$_CollectionsRelatedPhotoResponseCoverPhoto(
      {this.id,
  ...
  factory _$_CollectionsRelatedPhotoResponseCoverPhoto.fromJson(
          Map<String, dynamic> json) =>
      _$$_CollectionsRelatedPhotoResponseCoverPhotoFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$CollectionsRelatedPhotoResponseCoverPhotoCopyWith<
          _CollectionsRelatedPhotoResponseCoverPhoto>
      get copyWith => __$CollectionsRelatedPhotoResponseCoverPhotoCopyWithImpl<
          _CollectionsRelatedPhotoResponseCoverPhoto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CollectionsRelatedPhotoResponseCoverPhotoToJson(this);
  }
}

abstract class _CollectionsRelatedPhotoResponseCoverPhoto
    implements CollectionsRelatedPhotoResponseCoverPhoto {
  const factory _CollectionsRelatedPhotoResponseCoverPhoto(
      {String? id,
      @JsonKey(name: "created_at")
          DateTime? createdAt,
      @JsonKey(name: "updated_at")
      ...
      @JsonKey(name: "current_use_collections")
          List<dynamic>? currentUserCollections,
      Sponsorship? sponsorship,
      User? user}) = _$_CollectionsRelatedPhotoResponseCoverPhoto;

  factory _CollectionsRelatedPhotoResponseCoverPhoto.fromJson(
          Map<String, dynamic> json) =
      _$_CollectionsRelatedPhotoResponseCoverPhoto.fromJson;
...
CollectionsRelatedPhotoResponseLinks
    _$CollectionsRelatedPhotoResponseLinksFromJson(Map<String, dynamic> json) {
  return _CollectionsRelatedPhotoResponseLinks.fromJson(json);
}

/// @nodoc
class _$CollectionsRelatedPhotoResponseLinksTearOff {
  const _$CollectionsRelatedPhotoResponseLinksTearOff();

  _CollectionsRelatedPhotoResponseLinks call(
      {String? self, String? html, String? photos, String? related}) {
    return _CollectionsRelatedPhotoResponseLinks(
      self: self,
      html: html,
      photos: photos,
      related: related,
  ...
  CollectionsRelatedPhotoResponseLinks fromJson(Map<String, Object> json) {
    return CollectionsRelatedPhotoResponseLinks.fromJson(json);
  }
}

/// @nodoc
const $CollectionsRelatedPhotoResponseLinks =
    _$CollectionsRelatedPhotoResponseLinksTearOff();

/// @nodoc
mixin _$CollectionsRelatedPhotoResponseLinks {
  String? get self => throw _privateConstructorUsedError;
  String? get html => throw _privateConstructorUsedError;
  String? get photos => throw _privateConstructorUsedError;
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $CollectionsRelatedPhotoResponseLinksCopyWith<
          CollectionsRelatedPhotoResponseLinks>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CollectionsRelatedPhotoResponseLinksCopyWith<$Res> {
  factory $CollectionsRelatedPhotoResponseLinksCopyWith(
          CollectionsRelatedPhotoResponseLinks value,
          $Res Function(CollectionsRelatedPhotoResponseLinks) then) =
      _$CollectionsRelatedPhotoResponseLinksCopyWithImpl<$Res>;
  $Res call({String? self, String? html, String? photos, String? related});
}

/// @nodoc
class _$CollectionsRelatedPhotoResponseLinksCopyWithImpl<$Res>
    implements $CollectionsRelatedPhotoResponseLinksCopyWith<$Res> {
  _$CollectionsRelatedPhotoResponseLinksCopyWithImpl(this._value, this._then);

  final CollectionsRelatedPhotoResponseLinks _value;
  // ignore: unused_field
  final $Res Function(CollectionsRelatedPhotoResponseLinks) _then;
...
/// @nodoc
abstract class _$CollectionsRelatedPhotoResponseLinksCopyWith<$Res>
    implements $CollectionsRelatedPhotoResponseLinksCopyWith<$Res> {
  factory _$CollectionsRelatedPhotoResponseLinksCopyWith(
          _CollectionsRelatedPhotoResponseLinks value,
          $Res Function(_CollectionsRelatedPhotoResponseLinks) then) =
      __$CollectionsRelatedPhotoResponseLinksCopyWithImpl<$Res>;
  @override
  $Res call({String? self, String? html, String? photos, String? related});
}

/// @nodoc
class __$CollectionsRelatedPhotoResponseLinksCopyWithImpl<$Res>
    extends _$CollectionsRelatedPhotoResponseLinksCopyWithImpl<$Res>
    implements _$CollectionsRelatedPhotoResponseLinksCopyWith<$Res> {
  __$CollectionsRelatedPhotoResponseLinksCopyWithImpl(
      _CollectionsRelatedPhotoResponseLinks _value,
      $Res Function(_CollectionsRelatedPhotoResponseLinks) _then)
      : super(_value, (v) => _then(v as _CollectionsRelatedPhotoResponseLinks));

  @override
  _CollectionsRelatedPhotoResponseLinks get _value =>
      super._value as _CollectionsRelatedPhotoResponseLinks;
  ...
  $Res call({
    ...
    return _then(_CollectionsRelatedPhotoResponseLinks(
      self: self == freezed
          ? _value.self
          : self // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_CollectionsRelatedPhotoResponseLinks
    implements _CollectionsRelatedPhotoResponseLinks {
  const _$_CollectionsRelatedPhotoResponseLinks(
      {this.self, this.html, this.photos, this.related});

  factory _$_CollectionsRelatedPhotoResponseLinks.fromJson(
          Map<String, dynamic> json) =>
      _$$_CollectionsRelatedPhotoResponseLinksFromJson(json);
  ...
  @override
  String toString() {
    return 'CollectionsRelatedPhotoResponseLinks(self: $self, html: $html, photos: $photos, related: $related)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _CollectionsRelatedPhotoResponseLinks &&
            (identical(other.self, self) ||
                const DeepCollectionEquality().equals(other.self, self)) &&
            (identical(other.html, html) ||
                const DeepCollectionEquality().equals(other.html, html)) &&
  ...
  @JsonKey(ignore: true)
  @override
  _$CollectionsRelatedPhotoResponseLinksCopyWith<
          _CollectionsRelatedPhotoResponseLinks>
      get copyWith => __$CollectionsRelatedPhotoResponseLinksCopyWithImpl<
          _CollectionsRelatedPhotoResponseLinks>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CollectionsRelatedPhotoResponseLinksToJson(this);
  }
}

abstract class _CollectionsRelatedPhotoResponseLinks
    implements CollectionsRelatedPhotoResponseLinks {
  const factory _CollectionsRelatedPhotoResponseLinks(
      {String? self,
      String? html,
      String? photos,
      String? related}) = _$_CollectionsRelatedPhotoResponseLinks;

  factory _CollectionsRelatedPhotoResponseLinks.fromJson(
          Map<String, dynamic> json) =
      _$_CollectionsRelatedPhotoResponseLinks.fromJson;
...
class _$_PreviewPhoto implements _PreviewPhoto {
  ...
  @override
  String toString() {
    return 'PreviewPhoto(urls: $urls, id: $id, createdAt: $createdAt, updatedAt: $updatedAt, blurHash: $blurHash)';
  }
...
abstract class _PreviewPhoto implements PreviewPhoto {
  const factory _PreviewPhoto(
      ...
      @JsonKey(name: "created_at") DateTime? createdAt,
      @JsonKey(name: "updated_at") DateTime? updatedAt,
      @JsonKey(name: "blur_hash") String? blurHash}) = _$_PreviewPhoto;
...
mixin _$Source {
  ...
  @JsonKey(name: "cover_photo")
  SourceCoverPhoto? get coverPhoto => throw _privateConstructorUsedError;
...
abstract class _Source implements Source {
  const factory _Source(
      ...
      @JsonKey(name: "meta_title") String? metaTitle,
      @JsonKey(name: "meta_description") String? metaDescription,
      @JsonKey(name: "cover_photo") SourceCoverPhoto? coverPhoto}) = _$_Source;
